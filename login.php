...
<body style="background-color: #494949;">
	...
	<main>
		<div class="card">
			<div class="card-body">
		<form action="loginProceso.php" class="formulario" id="formulario" method="POST" style="padding: 20px;">
			...
			<div class="formulario__grupo formulario__grupo-btn-enviar">
				<input type="submit" id="enviar" name="enviar" class="formulario__btn">
